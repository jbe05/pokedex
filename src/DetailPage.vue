<template>
  <div class="flex justify-center">
    <div id="contain" class="w-2/3 flex items-center flex-col h-auto px-8 pb-12 pt-6 shadow-lg rounded-lg" >
      ...
      <div class="flex justify-between w-full">
        <img :src="pokemon.image" alt="pokemon" class="w-1/3">
        <div class="flex flex-col w-1/2">
          ...
          <h1 class="font-bold text-2xl font-mono text-white">Pokemon types</h1>
          <hr class="w-1/2 my-2">
          ...
          <div class="mt-16 grid grid-cols-3 gap-4">
            <button id="abilities" class="py-2 rounded-lg font-semibold text-lg text-black bg-white">abilities</button>
            <button id="moves" class="py-2 rounded-lg font-semibold text-lg text-black bg-white">moves</button>
            <button id="stats" class="py-2 rounded-lg font-semibold text-lg text-black bg-white">stats</button>
          </div>
